  ...
  const onSubmit = async () => {
    try {
      ...
      const { data } = isEditing
        ? await axios.patch(`/topreklamas/${id}`, fields)
        : await axios.post("/topreklamas", fields);
  
      const _id = isEditing ? id : data._id;
  
      navigate(`/topreklamas/${_id}`);
    } catch (err) {
      console.warn(err);
