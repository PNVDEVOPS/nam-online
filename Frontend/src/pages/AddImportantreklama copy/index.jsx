...
export const AddImportantreklama = () => {
  const { id } = useParams();
  ...
  const onSubmit = async () => {
    try {
      ...
      const { data } = isEditing
        ? await axios.patch(`/importantreklamas/${id}`, fields)
        : await axios.post("/importantreklamas", fields);
  
      const _id = isEditing ? id : data._id;
  
      navigate(`/importantreklamas/${_id}`);
    } catch (err) {
      console.warn(err);
...
export default AddImportantreklama;
